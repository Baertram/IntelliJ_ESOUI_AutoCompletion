...
--- @param laterTime deprecated_timestamp_64
--- @param earlierTime deprecated_timestamp_64
...
--- @return timestamp deprecated_timestamp_64
...
--- @param timestamp deprecated_timestamp_64
...
--- @param displayName string
--- @return void
function InviteToTribute(displayName) end
...
--- @return tributeInviteState [TributeInviteState|#TributeInviteState], partnerCharacterName string, partnerDisplayName string, targetType [TributePlayerType|#TributePlayerType]
...
--- @param overrideRank integer:nilable
--- @return cost integer
function GetAbilityCost(abilityId, mechanicFlag, overrideRank) end

--- @param abilityId integer
--- @param mechanic [CombatMechanicFlags|#CombatMechanicFlags]
--- @param overrideRank integer:nilable
--- @return cost integer, chargeFrequencyMS integer
...
function GetTributeMechanicTargetingText(mechanicType, quantity, param1, param2, param3) end
...
--- @param param2 integer
--- @return targetingText string
function GetTributePatronRequirementTargetingText(requirementType, quantity, param1, param2) end
...
--- @param cardDefId integer
--- @param trigger [TributeMechanicTrigger|#TributeMechanicTrigger]
--- @return numMechanics integer
function GetNumTributeCardMechanics(cardDefId, trigger) end

--- @param cardDefId integer
--- @param trigger [TributeMechanicTrigger|#TributeMechanicTrigger]
--- @param mechanicIndex luaindex
--- @return mechanicType [TributeMechanic|#TributeMechanic], quantity integer, comboNum integer, param1 integer, param2 integer, param3 integer
function GetTributeCardMechanicInfo(cardDefId, trigger, mechanicIndex) end
...
function GetTributeCardMechanicText(cardDefId, trigger, mechanicIndex, prependIcon) end
...
--- @return timeRemainingMs integer
function GetActiveTributeCampaignTimeRemainingMs() end

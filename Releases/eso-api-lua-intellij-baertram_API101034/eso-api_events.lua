...
--- @param isLastUpdateForMessage bool
--- @return void
function EVENT_INVENTORY_SINGLE_SLOT_UPDATE (eventId, bagId, slotIndex, isNewItem, itemSoundCategory, inventoryUpdateReason, stackCountChange, triggeredByCharacterName, triggeredByDisplayName, isLastUpdateForMessage) end
...
--- @param inviterDisplayName string
--- @return void
function EVENT_TRIBUTE_INVITE_RECEIVED (eventId, inviterCharacterName, inviterDisplayName) end

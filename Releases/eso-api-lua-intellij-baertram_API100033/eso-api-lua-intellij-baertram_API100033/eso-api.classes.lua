...
--- @param text string
--- @return scaledPixelWidth number
...
--- @param lineSpacingPixels integer
--- @return void
function LabelControl:SetLineSpacing(lineSpacingPixels) end
...
--- @param newLineXPixels number
--- @return void
function LabelControl:SetNewLineX(newLineXPixels) end
...
--- @return minPixels integer, maxPixels integer, percent number
...
--- @param minPixels integer
--- @param maxPixels integer
--- @param percent number
--- @return void
function PolygonControl:SetBorderThickness(minPixels, maxPixels, percent) end

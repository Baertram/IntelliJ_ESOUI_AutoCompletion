...
echo Done - Created file "/_out/DumpVars_vars.lua". 
echo.
echo For further details read file /DumpVars/HowToDumpVar.txt. In short:
echo You can use the bat file "2_deploy_DumpVars.bat" to copy the DumpVars addon and the created file DumpVars_vars.lua to your live/AddOns/ folder!
